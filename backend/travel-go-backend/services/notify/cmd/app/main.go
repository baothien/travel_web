...
import (
	...
	"gitlab.com/virtual-travel/travel-go-backend/services/notify/delivery/http"
	"gitlab.com/virtual-travel/travel-go-backend/services/notify/docs"
	"gitlab.com/virtual-travel/travel-go-backend/services/notify/migrations"
...
func main() {
	...
	docs.SwaggerInfo.Description = fmt.Sprintf("Virtual Travel")
