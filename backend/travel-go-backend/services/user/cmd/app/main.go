...
import (
	...
	"gitlab.com/virtual-travel/travel-go-backend/services/user/delivery/http"
	"gitlab.com/virtual-travel/travel-go-backend/services/user/docs"
	"gitlab.com/virtual-travel/travel-go-backend/services/user/migrations"
...
func main() {
	...
	docs.SwaggerInfo.Description = fmt.Sprintf("Cabx")
